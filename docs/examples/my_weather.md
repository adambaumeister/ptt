# Basic, Task Based Agentic Handling Example

The following example implements agentic handling using `TaskFlowBehavior`, which it uses to pass a user query
and convert it two calls in a row.
